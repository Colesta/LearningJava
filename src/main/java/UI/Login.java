...
public class Login extends javax.swing.JFrame {
    ...
    private void LoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_LoginActionPerformed
        ...
        try {
            ...
            String currentUsername = fileSc.next();
            String currentPassword = fileSc.next();

            if (inUsername.equals(currentUsername) && inPassword.equals(currentPassword)) {

                textArea.setText("Logged in succesfully");
